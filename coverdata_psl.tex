...
\author{\\ \textsc{Tigrane} CANTAT-MOLTRECHT}

%\thesis{THÈSE DE DOCTORAT \protect\\DE L'ÉCOLE NORMALE SUPÉRIEURE}

\institute{l'\textsc{\'Ecole Normale Supérieure}\\
au sein du \textsc{Laboratoire Kastler-Brossel}}

\logopath{figures/logos}

\specialty{PHYSIQUE QUANTIQUE}

\doctoralschool{\og Physique en Île-de-France\fg}{564}

%\lab{DÉPARTEMENT DE PHYSIQUE DE L'ÉCOLE NORMALE SUPÉRIEURE \\ LABORATOIRE KASTLER BROSSEL}

\title{
\begin{center}
Atomes de Rydberg en interaction : \\
des nuages denses d'atomes de Rydberg \\
à la simulation quantique avec des atomes circulaires
\end{center}
}
...
\supervisor{\textsc{Michel} BRUNE}

\date{11 janvier 2018}

\jury{
M. BRUNE \textsc{Michel}\\
ENS Paris, Directeur de thèse

M. KAISER \textsc{Robin}\\
INLN Nice, Rapporteur

M. SAYRIN \textsc{Clément}\\
SU, Membre invité

Mme. TARRUELL \textsc{Leticia}\\
ICFO Barcelone, Examinatrice

M. TIGNON \textsc{Jérôme}\\
SU, Président du jury

M. WEIDEMÜLLER \textsc{Matthias}\\
Universiät Heidelberg, Rapporteur
}
...
\frabstract{
\textsc{Atomes de Rydberg en interaction : des nuages denses d'atomes de Rydberg à la simulation quantique avec des atomes circulaires}\\
\begin{small}
...
\frkeywords{atomes de Rydberg, atomes froids, simulation quantique, interaction dipolaire, atomes circulaires, puce atomique, blocage dipolaire, spectroscopie microonde}


%\titleen{Interacting Rydberg Atoms : from Dense Clouds of Rydberg Atoms to Quantum Simulation with Circular Atoms}
\enabstract{
\textsc{Interacting Rydberg Atoms : from Dense Clouds of Rydberg Atoms to Quantum Simulation with Circular Atoms} \\
\begin{small}
...
\enkeywords{Rydberg atoms, cold atoms, quantum simulation, dipolar interactions, circular atoms, atomic chip, dipole blockade, microwave spectroscopy}
