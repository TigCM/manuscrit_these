...
Les rapports $\Omega/J$ et $\Delta/J$ sont en effet facilement contrôlables en variant respectivement la puissance et la fréquence du champ microonde utilisé, alors que $J_z/J$ dépend des niveaux atomiques choisis et des champs électrique et magnétique extérieurs.
...
L'évolution temporelle du système est dominée par le terme d'échange de l'interaction de van der Waals, avec un temps caractéristique $\tau_{\text{\'ech}} = 1/(4J)$.
Ce temps d'échange vaut $\tau_{\text{\'ech}} = \SI{14.7}{\us}$ lorsque les atomes sont séparés de $r=\SI{5}{\um}$.
...
Pour obtenir un pas de réseau de $d=\SI{5}{}$, cet angle doit prendre une valeur $\theta=\SI{5.7}{\degree}$.
...
Cette chaîne atomique est piégée dans un potentiel laser périodique, avec une durée de vie supérieure à la seconde grâce à l'inhibition de l'émission spontanée.
