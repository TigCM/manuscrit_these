...
La distribution spatiale des atomes de Rydberg excités après une impulsion laser de $\SI{2}{\us}$ est représentée en figure \eqref{fig:spatial_distrib_sim}.
%
\begin{figure}[h]
\centering
distribution spatiale à résonance et à 2MHz, image2D + "gaussienne" selon une direction\\
pour $\SI{2}{\us}$
\caption[Distribution spatiale simulée des atomes de Rydberg]{
Distribution spatiale simulée des atomes de Rydberg.
}
...
\caption[\'Evolution simulée du nombre d'atomes de Rydberg excités en fonction du temps]{
\'Evolution simulée du nombre d'atomes de Rydberg excités en fonction du temps, pour différents désaccords laser : $\SI{0}{},\SI{2}{},\SI{4}{}$ et $\SI{8}{\MHz}$.
}
