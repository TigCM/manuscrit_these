...
%Les atomes de Rydberg, en tant que grand dipôle électriques, présentent
%Une autre particularité des atomes de Rydberg réside dans l'interaction entre eux, en tant que grands dipôles électriques.
Les atomes de Rydberg présentent aussi la particularité d'interagir fortement les uns avec les autres, en tant que grands dipôles électriques.
...
%Dans un second temps, nous nous intéressons à la simulation quantique.
...
Dans certains cas, calculer, même numériquement, l'évolution temporelle d'un tel système demande la réalisation d'opérations lourdes %, telles que l'exponentiation, 
